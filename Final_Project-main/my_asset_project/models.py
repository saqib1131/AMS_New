...
class Asset_Details(db.Model):
    ...
    other_insurance = db.Column(db.String(20))
    ...
    having_issue = db.Column(db.String(20))
    incident_id = db.Column(db.String(60))
    remarks = db.Column(db.String(100))
    payment_done = db.Column(db.String(20))
    payment_date = db.Column(db.Date)
    amount_paid = db.Column(db.Float)
    voucher_number = db.Column(db.String(60))
    ...
    monitor_screen_type = db.Column(db.String(20))
    ups_capacity = db.Column(db.String(60))
    ups_amc = db.Column(db.String(60))  
    ups_start_date = db.Column(db.Date)
    ups_end_date =db.Column(db.Date)
    source_of_purchase = db.Column(db.String(20))
    contract_id = db.Column(db.String(60))
